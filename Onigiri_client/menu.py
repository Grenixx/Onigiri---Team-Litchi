...
FONT_NAME = None  
FONT_SIZE = 36
CONTROLS={"LEFT":pygame.K_q,"RIGHT":pygame.K_d,"JUMP":pygame.K_SPACE,"DASH":pygame.K_LSHIFT,"CHANGE ARM":pygame.K_TAB,"UP":pygame.K_z,"DOWN":pygame.K_s,"ATTACK":pygame.K_f}
DATA = {
...
def cleanup_server():
    ...
    if sys.platform == "win32":
        try:
            ...
            subprocess.run(['taskkill', '/F', '/FI', 'WINDOWTITLE eq Onigiri Server*', '/T'], 

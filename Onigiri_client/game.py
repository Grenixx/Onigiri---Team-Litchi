...
class Game:
    def __init__(self, max_fps=60, resolution : list = [0, 0], ip="127.0.0.1"):
        ...
        self.assets = {
            ...
            'Projectile/idle':load_animation_with_masks(resource_path('data/images/entities/enemy/Projectile/idle'), img_dur=2, loop=False, convert_alpha=False, col_path=resource_path('data/images/entities/enemy/Projectile/idle')),
            'Projectile/spawn':load_animation_with_masks(resource_path('data/images/entities/enemy/Projectile/spawn'), img_dur=2, loop=True, convert_alpha=False, col_path=resource_path('data/images/entities/enemy/Projectile/spawn')),

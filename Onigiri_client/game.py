...
class Game:
    def __init__(self, max_fps=60, resolution : list = [0, 0], ip="127.0.0.1"):
        ...
        self.assets = {
            ...
            'Projectile/rage':load_animation_with_masks(resource_path('data/images/entities/enemy/Projectile/rage'), img_dur=2, loop=True, convert_alpha=False, col_path=resource_path('data/images/entities/enemy/Projectile/rage')),
